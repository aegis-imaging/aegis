...
api_target_group_name="$(terraform_output_raw "api_target_group_name" || true)"
admin_target_group_name="$(terraform_output_raw "admin_target_group_name" || true)"
...
api_target_group_name="${api_target_group_name:-${PROJECT_NAME}-api}"
admin_target_group_name="${admin_target_group_name:-${PROJECT_NAME}-admin}"
...
check_target_group_health "$api_target_group_name"
check_target_group_health "$admin_target_group_name"
