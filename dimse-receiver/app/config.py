...
# Optional retry alerting controls
DIMSE_RETRY_ALERTS_ENABLED: bool = _env_bool("DIMSE_RETRY_ALERTS_ENABLED", False)
DIMSE_RETRY_ALERT_MAX_EVENTS: int = int(os.getenv("DIMSE_RETRY_ALERT_MAX_EVENTS", "200"))
DIMSE_RETRY_ALERT_COOLDOWN_SECONDS: int = int(os.getenv("DIMSE_RETRY_ALERT_COOLDOWN_SECONDS", "300"))
DIMSE_RETRY_ALERT_PENDING_AGE_SECONDS: int = int(os.getenv("DIMSE_RETRY_ALERT_PENDING_AGE_SECONDS", "0"))
DIMSE_RETRY_ALERT_DEAD_LETTER_AGE_SECONDS: int = int(os.getenv("DIMSE_RETRY_ALERT_DEAD_LETTER_AGE_SECONDS", "0"))
DIMSE_RETRY_ALERT_DEAD_LETTER_NONZERO: bool = _env_bool("DIMSE_RETRY_ALERT_DEAD_LETTER_NONZERO", True)
DIMSE_RETRY_ALERT_WEBHOOK_URL: str = os.getenv("DIMSE_RETRY_ALERT_WEBHOOK_URL", "")
