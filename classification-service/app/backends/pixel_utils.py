...
Converts a DICOM file's pixel array to a PIL Image suitable for
cloud vision label inference. Used by cloud classification backends.
...
def dicom_to_pil(path: str) -> Optional["PIL.Image.Image"]:
    ...
    # Multi-frame: use first frame only.
