...
const MARKET_CARDS = [
  ...
  },
  {
    ...
    detail: 'AEGIS is live on GCP, AWS, and Azure — microservices architecture (Go API + 9 Python microservices + MCP server) on all three clouds. Cross-cloud DICOM routing verified. Full audit trail built in.',
    accent: '#059669',
  },
]
