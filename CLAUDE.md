...
- **Timestamp rendering** — admin dashboard and export portal default to explicit UTC format and now support user-selectable viewing time zones (`UTC`, browser local, or custom IANA zone like `America/Chicago`) for display-only conversion
